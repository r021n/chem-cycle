    ...
    return (
      <div className="w-full font-sans">
        ...
        <textarea
          ...
          rows={rows}
          className={cn(
            'w-full bg-chem-subtle/70 px-3.5 py-2.5 text-xs sm:text-sm text-chem-dark border border-chem-border rounded-xl placeholder:text-chem-ash/50 focus:bg-white focus:outline-none focus:border-chem-sage transition-all disabled:opacity-50 disabled:bg-chem-subtle resize-y',
